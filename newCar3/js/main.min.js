...
const chat3 = () => {
  ...
  if (msgBlockChoice) {
    ...
    const blockChoiceClick = e => {
      ...
      if ((0,_helpers_js__WEBPACK_IMPORTED_MODULE_1__.containsClass)(targetEvent, 'choice-car__btn-buy') || (0,_helpers_js__WEBPACK_IMPORTED_MODULE_1__.containsClass)(targetEvent, 'choice-car__tel') || (0,_helpers_js__WEBPACK_IMPORTED_MODULE_1__.containsClass)(targetEvent, 'choice-car__btn-order')) {
        return;
      }

      // блок на который нажали проверка на то есть ли у него родитель с таким классом
      const block = (0,_helpers_js__WEBPACK_IMPORTED_MODULE_1__.closestElement)(targetEvent, 'block-choice');
...
choiceCarBlocks.addEventListener('click', e => {
  ...
  if ((0,_helpers_js__WEBPACK_IMPORTED_MODULE_0__.containsClass)(btnOpen, 'choice-car__btn-buy') || (0,_helpers_js__WEBPACK_IMPORTED_MODULE_0__.containsClass)(btnOpen, 'choice-car__btn-order')) {
    let modal;
    // кнопка купить
    if ((0,_helpers_js__WEBPACK_IMPORTED_MODULE_0__.containsClass)(btnOpen, 'choice-car__btn-buy')) {
      modal = document.querySelector('.modal-btnUnderCar');
    }
    // кнопка забронировать
    if ((0,_helpers_js__WEBPACK_IMPORTED_MODULE_0__.containsClass)(btnOpen, 'choice-car__btn-order')) {
