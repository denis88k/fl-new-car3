...
// promo-header
(0,_components_modal_js__WEBPACK_IMPORTED_MODULE_1__["default"])('.promo__header-modal-payment', '.modal-payment', '.modal-payment .modal__close');
(0,_components_modal_js__WEBPACK_IMPORTED_MODULE_1__["default"])('.promo__header-modal-tradIn', '.modal-tradIn', '.modal-tradIn .modal__close');
...
(0,_components_modal_js__WEBPACK_IMPORTED_MODULE_1__["default"])('.report__about-btn-red', '.modal-btnUnderCar', '.modal-btnUnderCar .modal__close');
(0,_components_modal_js__WEBPACK_IMPORTED_MODULE_1__["default"])('.report__about-btn-white', '.modal-btnUnderCar', '.modal-btnUnderCar .modal__close');
...
const showLastChat = chat => {
  setTimeout(() => {
    (0,_helpers_js__WEBPACK_IMPORTED_MODULE_0__.addClass)(chatBlock[1], 'msg-show'); // 6
    (0,_helpers_js__WEBPACK_IMPORTED_MODULE_0__.addClass)(chatBlock[2], 'msg-show'); // 7
...
const hiddenLastChat = () => {
  (0,_helpers_js__WEBPACK_IMPORTED_MODULE_0__.removeClass)(chatBlock[1], 'msg-show'); // 6
  (0,_helpers_js__WEBPACK_IMPORTED_MODULE_0__.removeClass)(chatBlock[2], 'msg-show'); // 7
...
/* harmony export */ });
/* harmony import */ var _checkbox_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./checkbox.js */ "./src/js/components/checkbox.js");
/* harmony import */ var _helpers_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./helpers.js */ "./src/js/components/helpers.js");
/* harmony import */ var _visibleBlockAndBtnShowMore_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./visibleBlockAndBtnShowMore.js */ "./src/js/components/visibleBlockAndBtnShowMore.js");
...
const yearsShowSelect = () => {
  ...
  selects.addEventListener('click', e => {
    const selectInput = (0,_helpers_js__WEBPACK_IMPORTED_MODULE_1__.closestElement)(e.target, 'years__input');
    const YearsOption = (0,_helpers_js__WEBPACK_IMPORTED_MODULE_1__.closestElement)(e.target, 'years__option');
    if (selectInput) {
      // console.log('selectInput====');
      // count++;
      const selector = selectInput.nextElementSibling; // блок со списком годов
      (0,_helpers_js__WEBPACK_IMPORTED_MODULE_1__.toggleClass)(selectInput, 'active');
      (0,_helpers_js__WEBPACK_IMPORTED_MODULE_1__.toggleClass)(selector, 'active');
    ...
    if (YearsOption) {
      ...
      (0,_helpers_js__WEBPACK_IMPORTED_MODULE_1__.removeClassArray)(options, 'active');
      ...
      const optionContainsFrom = (0,_helpers_js__WEBPACK_IMPORTED_MODULE_1__.containsClass)(YearsOption.parentElement, 'select-from');
      const optionContainsTo = (0,_helpers_js__WEBPACK_IMPORTED_MODULE_1__.containsClass)(YearsOption.parentElement, 'select-to');
      const checkboxBlocks = document.querySelectorAll('.years__checkbox-block'); // блоки checkbox с поколениями
      if ((0,_helpers_js__WEBPACK_IMPORTED_MODULE_1__.containsClass)(YearsOption, 'option')) {
        // console.log('option====', YearsOption);
        // count++;
        const option = YearsOption.closest('.option');
        (0,_helpers_js__WEBPACK_IMPORTED_MODULE_1__.addClass)(option, 'active');
      ...
      if ((0,_helpers_js__WEBPACK_IMPORTED_MODULE_1__.containsClass)(YearsOption, 'clear')) {
  ...
  document.addEventListener('click', function (e) {
    if (!e.target.closest('.years__input')) {
      ...
      document.querySelectorAll('.years__input').forEach(selectInput => {
        (0,_helpers_js__WEBPACK_IMPORTED_MODULE_1__.removeClass)(selectInput, 'active');
        (0,_helpers_js__WEBPACK_IMPORTED_MODULE_1__.removeClass)(selectInput.nextElementSibling, 'active');
      });
...
const yearsDefaultState = () => {
  document.querySelectorAll('.years__input').forEach(selectInput => {
    ...
    (0,_helpers_js__WEBPACK_IMPORTED_MODULE_1__.removeClass)(selector, 'active');
    const option = selector.querySelectorAll('.option');
    (0,_helpers_js__WEBPACK_IMPORTED_MODULE_1__.removeClassArray)(option, 'active');
  });
...
/* harmony import */ var _components_stickyConsultant_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/stickyConsultant.js */ "./src/js/components/stickyConsultant.js");
/* harmony import */ var _components_years_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/years.js */ "./src/js/components/years.js");
...
window.addEventListener('scroll', _components_stickyConsultant_js__WEBPACK_IMPORTED_MODULE_1__["default"]);
// NOTE: =================MODEL CHOICE===============
// ========================================

// NOTE: =================YEARS===============

(0,_components_years_js__WEBPACK_IMPORTED_MODULE_2__.yearsInit)();
//* yearsShowSelect();
