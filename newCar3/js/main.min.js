...
const showLastChat = chat => {
  setTimeout(() => {
    (0,_helpers_js__WEBPACK_IMPORTED_MODULE_0__.addClass)(chatLastBlock, 'msg-show'); // 6
...
const hiddenLastChat = () => {
  (0,_helpers_js__WEBPACK_IMPORTED_MODULE_0__.removeClass)(chatLastBlock, 'msg-show'); // 6
...
/* harmony export */   "filterBtnReset": () => (/* binding */ filterBtnReset)
/* harmony export */ });
